...
export function InstagramStats() {
  ...
  return (
    <section
      ...
      className="relative scroll-mt-24 overflow-hidden bg-zinc-950 px-4 py-12 text-zinc-100 sm:px-8 lg:px-16"
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl 2xl:max-w-[90rem]">
        ...
        <Reveal delay={0.2} className="mt-8 flex flex-col items-center gap-4 sm:mt-12">
