...
export function CTA() {
  ...
  return (
    <section
      id={SECTION_IDS.cta}
      className="scroll-mt-24 min-h-[56dvh] px-0 pb-0 sm:min-h-[72dvh]"
    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          <h2
            id="cta-heading"
            className="font-heading text-3xl font-medium tracking-tight text-[var(--brand-forest-foreground)] sm:text-4xl 2xl:text-5xl"
          >
            Empeza a planear tu viaje hoy
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-lg text-[var(--brand-forest-foreground)]/90 2xl:max-w-2xl 2xl:text-xl">
          ...
          <a
            ...
            className={cn(
              ...
              "mt-10 inline-flex h-12 rounded-full px-10 text-base font-semibold text-brand-forest shadow-lg 2xl:h-14 2xl:px-12 2xl:text-lg",
            )}
          >
