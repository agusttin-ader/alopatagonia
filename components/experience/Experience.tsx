...
export function Experience() {
  return (
    <section
      ...
      className="scroll-mt-24 border-y border-border/70 bg-secondary/40 px-4 py-12 sm:px-8 lg:px-14 2xl:px-20"
      aria-labelledby="experiencia-heading"
    >
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2 lg:items-center lg:gap-16 2xl:max-w-[90rem]">
        <Reveal
          className={cn(
