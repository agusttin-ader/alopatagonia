          ...
          {TESTIMONIALS.map((t, index) => (
            <li key={t.name}>
              <Reveal delay={index * 0.06}>
                <article
                  className={cn(
                    "group relative flex h-full flex-col rounded-2xl bg-card/60 px-6 py-7 sm:px-8 sm:py-9",
                    "shadow-sm ring-1 ring-brand-forest/10",
                    interactiveCardHover,
                  )}
                >
                  <span
                    className="pointer-events-none absolute left-7 top-7 font-heading text-5xl font-light leading-none text-brand-forest/15 select-none"
                    aria-hidden
                  >
                    “
                  </span>
                  <p className="relative text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-brand-forest/80">
                    {t.highlight}
                  </p>
                  ...
                  <div
                    className="relative mt-8 h-px w-12 bg-brand-forest/25"
                    aria-hidden
                  />
                </article>
              </Reveal>
